...
import FrequencyChart from "./chart/wavechart/FrequencyChart";
            ...
            <div className={styles.gridCardLarge}>
              ...
              <div className={styles.gridCardContentInner}>
                <p className={styles.paraContent}>
                  The key topics discussed in Microsoft's last quarterly
                  earnings call (Q2 2023) include:
                </p>
                <p className={styles.paraContent}>
                  Financial performance and outlook, cloud business performance,
                  device execution challenges, workforce and cost optimization
                  and strategic investments. Additionally, Microsoft discussed
                  its non-GAAP financial measures, as well as its strategy to
                  focus on growing its cloud business, building new products and
                  services, and continuing to invest in its people, technology,
                  and infrastructure.
                </p>
              </div>
            </div>
          ...
          <Grid item xs>
            <div className={styles.gridCardLarge}>
              ...
              <div className={styles.gridCardContentInner}>
                <ul>
                  <li>
                    Our entire analysis is generated from our Comprehend AI
                    voice engine.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    from all speakers to a question. Hesitancy has been
                    described as the canary in the coal mine for understanding
                    what one is responding with. The spectrogram representation
                    showcases just how much more is available from our
              ...
              <div className={styles.waveChartParentBlock}>
                <FrequencyChart />
              </div>
            </div>
          </Grid>
